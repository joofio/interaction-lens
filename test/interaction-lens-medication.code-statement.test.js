...
global.ips = JSON.parse(fs.readFileSync(path.join(__dirname, "../data/ips2.json")));
...
describe("Interaction Annotation Script (non-invasive)", () => {
  ...
  test("should return enhanced HTML containing highlight class for medication coding code - matching code and system", async () => {
    ...
    expect(result).toContain("interaction-lens");
  });
});
